...
namespace LiteNN
{
	...
	struct VulkanDeviceCapabilities
	{
		...
		std::uint32_t maxUpdateAfterBindDescriptorsInAllPools{};
		std::uint32_t maxPerStageDescriptorUpdateAfterBindStorageBuffers{};
		std::uint32_t maxDescriptorSetUpdateAfterBindStorageBuffers{};
		std::uint32_t maxDescriptorSetVariableDescriptorCount{};
		...
		bool subgroupVoteAvailable{};
		bool subgroupBallotAvailable{};
		bool subgroupShuffleAvailable{};
		bool subgroupShuffleRelativeAvailable{};
		bool subgroupClusteredAvailable{};
		bool subgroupQuadAvailable{};
		...
		bool shaderStorageBufferArrayNonUniformIndexingAvailable{};
		bool descriptorBindingStorageBufferUpdateAfterBindAvailable{};
		bool descriptorBindingPartiallyBoundAvailable{};
		bool descriptorBindingVariableDescriptorCountAvailable{};
		bool runtimeDescriptorArrayAvailable{};
		bool shaderFloat16Enabled{};
		bool shaderInt8Enabled{};
		bool storageBuffer16BitAccessEnabled{};
		bool storageBuffer8BitAccessEnabled{};
		bool shaderStorageBufferArrayNonUniformIndexingEnabled{};
		bool descriptorBindingStorageBufferUpdateAfterBindEnabled{};
		bool descriptorBindingPartiallyBoundEnabled{};
		bool descriptorBindingVariableDescriptorCountEnabled{};
		bool runtimeDescriptorArrayEnabled{};
