...
namespace LiteNN
{
	namespace
	{
		                                                              ...
		                                                              std::size_t axis, double epsilon)
		{
			...
			auto module = BuildAxisNormalizationF32SPIRVModule(mode, inputShape, axis, epsilon, context);
	                                                                 ...
	                                                                 std::size_t axis, double epsilon)
	{
		...
		return SerializeAxisNormalizationF32SPIRV(mode, inputShape, axis, epsilon);
	}
